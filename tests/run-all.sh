...
not_run="
cloud-copy-ui|needs Quickshell and usable Flea Commons imports; runs offscreen copy lifecycle tests
cloud-copy|needs optional rclone; runs isolated local backend copy and checksum tests
