...
function run(check) {
    ...
    check("default image menu matches Menus specimen", actions(file),
          "open,openWith,cut,copy,paste,duplicate,rename,compress,convert,cloudUpload,taildrop,dropbox,trash,addFavourite,toggleHidden")
    ...
    check("folder omits conversion and extraction", actions(Menu.listingEntries(state({ rowMode: 0o040755, rowIsImage: false }))),
          "open,openWith,cut,copy,paste,duplicate,rename,compress,cloudUpload,taildrop,dropbox,trash,addFavourite,toggleHidden")
